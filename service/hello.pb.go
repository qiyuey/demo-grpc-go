...
var file_proto_hello_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x76, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65,
	...
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x37, 0x0a, 0x09, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c,
	...
	0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x28, 0x01, 0x30, 0x01, 0x42, 0x23,
	0x0a, 0x15, 0x74, 0x6f, 0x70, 0x2e, 0x71, 0x69, 0x79, 0x75, 0x65, 0x79, 0x2e, 0x64, 0x65, 0x6d,
	0x6f, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x50, 0x01, 0x5a, 0x08, 0x2f, 0x73, 0x65, 0x72, 0x76,
...
var file_proto_hello_proto_depIdxs = []int32{
	...
	0, // 1: hello.Greeter.SayHellos:input_type -> hello.HelloRequest
	1, // 2: hello.Greeter.SayHello:output_type -> hello.HelloReply
	1, // 3: hello.Greeter.SayHellos:output_type -> hello.HelloReply
...
func (c *greeterClient) SayHellos(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHellosClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/hello.Greeter/SayHellos", opts...)
	if err != nil {
		return nil, err
	}
